        ...
        <>
            ...
            <div class="cont">
                ...
                <div class="pro" id="pro2">
                    <img src="/images/img2.jpg" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro3">
                    <img src="/images/img3.jpg" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro4">
                    <img src="/images/ups-battery.jpg" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro5">
                    <img src="/images/battery1.webp" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro6">
                    <img src="/images/frige.jpg" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro7">
                    <img src="/images/fridge2.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro8">
                    <img src="/images/cable1.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro9">
                    <img src="/images/cables2.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro10">
                    <img src="/images/tele1.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro11">
                    <img src="/images/tele2.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro12">
                    <img src="/images/lap2.jpg" alt="Product img" class="img"/>
                        <div class="imgdesc" id="name">
                            <h2>
                                {/* <!-- Product type and product brand should be extracted from backend --> */}
                                {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro13">
                    <img src="/images/mo1.jfif" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro14">
                    <img src="/images/mo2.jfif" alt="Product img" class="img"/>
                        <div class="imgdesc" id="name">
                            <h2>
                                {/* <!-- Product type and product brand should be extracted from backend --> */}
                                {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
                ...
                <div class="pro" id="pro15">
                    <img src="/images/sw.jpg" alt="Product img" class="img" />
                    <div class="imgdesc" id="name">
                        <h2>
                            {/* <!-- Product type and product brand should be extracted from backend --> */}
                            {/* <!-- The url should take the customers to respective laptop and lenovo section --> */}
